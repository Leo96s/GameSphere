...
builder.Services.AddScoped<AccountRecoveryCodeService>();
builder.Services.AddScoped<IAccountDeactivationService, AccountDeactivationService>();
builder.Services.AddScoped<IAccountRecoveryService, AccountRecoveryService>();
builder.Services.AddScoped<IAccountAnonymizer, AccountAnonymizer>();
builder.Services.AddHostedService<AccountAnonymizationSweeper>();
